...
const NO_PHOTO = { "light-cardio": { n: "Light cardio", t: "Raise core temperature", d: "3–5 min", s: ["Bike, rower or incline walk at a conversational pace.", "You want a light sweat and a raised heart rate, not fatigue."], c: "Never stretch a cold muscle. Warm it first, then move it." },
...
const PROGRAM = [
  ...
  { id: "legs-b", n: 6, day: "Legs B", focus: "Posterior focus", block: "legs", optional: true,
    ...
    slots: [
      ...
      { v: ["leg-press"], sets: 3, reps: "12–15", note: "High foot placement — shifts the load onto hamstrings and glutes." },
